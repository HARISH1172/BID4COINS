...
const Leaderboard = () => {
  ...
  return (
    <>
      <section className="w-full ml-0 m-0 h-fit px-5 pt-0 lg:pl-[320px] flex flex-col">
        {loading ? (
          <Spinner />
        ) : (
          <>
            {/* <div className="flex flex-col min-[340px]:flex-row min-[340px]:gap-2 mb-10"> */}
            <div>
              <h1
                className={`text-[#D6482B] text-2xl pt-10 font-bold mb-2 min-[480px]:text-4xl md:text-6xl xl:text-7xl 2xl:text-5xl`}
              >
                Bidders Leaderboard
              </h1>
