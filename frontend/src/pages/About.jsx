...
const About = () => {
  ...
  return (
    <>
      <section className="w-full ml-0 m-0 h-fit px-5 pt-0 lg:pl-[320px] gap-7 flex flex-col min-h-screen py-4 justify-center">
        <div>
          <h1
          ...
          <p className="text-xl text-stone-600">
            Welcome to Bid4Coins, the ultimate destination for online auctions
        ...
        <div>
          ...
          <p className="text-xl text-stone-600">
            At Bid4Coins, our mission is to revolutionize the way people buy and
        ...
        <div>
          ...
          <p className="text-xl text-stone-600">
            Founded by Harish wagh, Bid4Coins was born out of a passion for
        ...
        <div>
          ...
          <p className="text-xl text-stone-600">
            Whether you're looking to buy, sell, or simply explore, Bid4Coins
        ...
        <div>
          <p className="text-[#d6482b] text-xl font-bold mb-3">
            Thank you for choosing Bid4Coins. We look forward to being a part of
